...
### v2.9.5 更新內容（2024.11.19）
- ✅ 使用 Sidebar 的 Logo 圖片取代文字
- ✅ 縮短動畫時間：梯形(1.5秒) → Logo(1.5秒) → 淡出(0.8秒)
- ✅ 總時間從 7.5秒 → 3.8秒（減少等待，提升體驗）
- ✅ Logo 圖片：白字DTM LOGO.png
- 🎯 **快速流暢的進場動畫**

### v2.9.4 更新內容（2024.11.19）
- ✅ 梯形飛完後 Logo 才飛過去（獨立動畫）
- ✅ 動畫時間軸：梯形(0-3秒) → Logo(3-6秒) → 淡出(6-7.5秒)
- ✅ Logo 獨立於梯形外，z-index 更高確保可見
- ✅ 總動畫時間：7.5秒（給影片充足載入時間）
- 🎯 **清晰的分階段進場動畫**
