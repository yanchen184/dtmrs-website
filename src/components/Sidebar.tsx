  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="fixed left-0 top-0 w-80 h-64 bg-gradient-to-br from-red-600 to-red-700 z-50"
        style={{
            ...
            {menuItems.map((item, index) => (
              ...
              >
                <button
                  ...
                  className={`w-full text-left py-3 px-4 text-white text-base font-medium transition-all duration-300 hover:bg-white/20 rounded ${
