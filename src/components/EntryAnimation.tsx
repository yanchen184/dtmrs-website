      ...
      {showAnimation && (
        <>
          ...
          <motion.div
            initial={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            transition={{ duration: 0.3, delay: 1.2 }} // 加快淡出
          ...
          <motion.div
            ...
            transition={{
              x: {
                duration: 1.0, // 加快飛行速度
                ease: [0.6, 0.05, 0.01, 0.9] // 使用更流暢的曲線
              },
              opacity: {
                duration: 0.3,
                delay: 1.2
          ...
          >
            ...
            <div
              ...
              style={{
                width: '180vw', // 從 120vw 增加到 180vw
                left: '-20vw',
                clipPath: 'polygon(0 0, 100% 0, 70% 100%, 10% 100%)', // 調整讓上面更寬
